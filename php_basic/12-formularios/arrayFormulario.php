    ...
    <div class="container">
        ...
        <div class="col-md-12 well">
            <form role="form" id="myForm" action="arrayNuevoContacto.php" method="post">
                ...
                <div class="mb-3"> <select id="metodoPago" class="form-select" name="metodosPago[]" multiple>
                ...
                <div class="mb-3 form-check"> <input type="checkbox" class="form-check-input" id="marcar" name="contacto[marcar]">
